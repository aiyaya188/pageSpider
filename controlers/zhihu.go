...
func ZhihuSearch(webDriver selenium.WebDriver, target string) bool {
	...
	souButton, _ := webDriver.FindElement(selenium.ByXPATH, `//*[@id="searchForm"]/div/input`)
	souButton.Click()
	webDriver.SetImplicitWaitTimeout(30 * time.Second)
	//time.Sleep(5 * time.Second)
	wd, _ := webDriver.FindElements(selenium.ByClassName, `about-list-title`)
